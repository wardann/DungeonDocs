...
function DD.ui.settings.StyleRole_View(container)
	...
	-- Display role header
	DD.ui.shared.AddCheckBox(roleNotesSection, "Display role header", state, "displayRoleHeader", refresh)

	-- Add role header indent slider
	DD.ui.shared.AddSlider(roleNotesSection, "Role Header Indent", state, "roleHeaderIndent", 0, 15, 1)

	-- Add role note indent slider
	DD.ui.shared.AddSlider(roleNotesSection, "Role Note Indent", state, "roleNoteIndent", 0, 15, 1)
